...
<div class="title  text-white">
        <h4>Housemates / Environmental Concern</h4>
    </div>

    <div class="card text-center mt-3">
            <div class="card-header text-dark mb-3">
            <h5 class="card-title text-white bg-secondary ">Write A message</h5>
            </div>
<div class="form p-5 ">
            <form action="#">
                <textarea name="" id="" cols="30" rows="10" placeholder="Enter Concern here..." style="width:100%"></textarea><br>
